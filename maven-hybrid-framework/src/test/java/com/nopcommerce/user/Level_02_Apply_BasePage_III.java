...
public class Level_02_Apply_BasePage_III extends BasePage {
	...
	public void TC_03_Register_Success() {
		...
		Assert.assertEquals(getElementText(driver, "//div[@class='page-body']//div[@class='result']"), "Your registration completed");

		waitForElementClickable(driver, "//div[@class='buttons']//a");
		clickToElement(driver, "//div[@class='buttons']//a");
	}
