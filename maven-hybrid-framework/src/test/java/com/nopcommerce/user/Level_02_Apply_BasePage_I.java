...
//		basePage.clickToElement(driver, "//button[@id='register-button']");
//
//		Assert.assertEquals(basePage.getElementText(driver, "//div[@class='page-body']//div[@class='result']"), "Your registration completed");
//
//		basePage.waitForElementClickable(driver, "//div[@class='buttons']//a");
//		basePage.clickToElement(driver, "//div[@class='buttons']//a");
//	}
//
//	@Test
