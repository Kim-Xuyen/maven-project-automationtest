...
public class RegisterPageUI {
	...
	public static final String REGISTER_SUCCESS_MESSAGE = "xpath=//div[@class='page-body']//div[@class='result']";
	public static final String CONTINUE_LINK = "xpath=//div[@class='buttons']//a";
