...
public class HomePageUI {
	...
	public static final String TOTAL_PAGING = "css=ul.qgrd-pagination-ul > li.qgrd-pagination-page";
	...
	public static final String ICON_NAME_ROW_NUMBER = "xpath=//tbody//tr[%s]//button[@title='%s']";
