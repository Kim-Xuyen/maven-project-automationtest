...
public class AdminPostSearchPO extends BasePage {
	...
	public boolean isPostSearchTableDisplayed(String headerID, String cellValue) {
		...
		waitForElementVisible(driver, AdminPostSearchPageUI.TABLE_HEADER_VALUE_BY_HEADER_INDEX, String.valueOf(headerIndex), cellValue);
		return isElementDisplayed(driver, AdminPostSearchPageUI.TABLE_HEADER_VALUE_BY_HEADER_INDEX, String.valueOf(headerIndex), cellValue);
	}
